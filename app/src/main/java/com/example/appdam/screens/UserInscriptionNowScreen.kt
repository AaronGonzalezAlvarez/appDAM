...
@Composable
fun UserInscriptionTodayScreen(
    viewModel: UserInscriptionTodayViewModel = viewModel(),
...
@Composable
fun MenuBodyUserInscriptionToday(
    innerPadding: PaddingValues,
    navController: NavHostController,
    dataUiState: MenuUiState,
    viewModel: UserInscriptionTodayViewModel
) {
    Box(
        ...
        Box(
            ...
            if(dataUiState.inscriptionToday.size==0){
                Card(
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(350.dp)
                ...
                dataUiState.inscriptionToday.let { activity ->
                    LazyColumn(
